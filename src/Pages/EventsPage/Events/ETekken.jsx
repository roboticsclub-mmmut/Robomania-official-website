...
const ETekken = () => {
  ...
  return (
    <>
      <div className="eventpage-container et">
        <NavMenu />
        <div className="eventpage-hero">
          <img src={roboGif} alt="robogif" />
          <h1 style={{color: "#000040", textShadow: "2px 2px 4px #ffffff, -2px -2px 4px #ffffff"}}>Electro Tekken</h1>
      ...
      <div className="eventpage-section">
        <div className="eventpage-description">
          ...
          <div class="eventpage-description-right">
            ...
            <strong>Electro Tekken</strong> is the ultimate challenge. In this electrifying twist, players will make real-life physical moves, and watch as the action unfolds in the game. Every punch, kick, and combo you throw will be translated directly into the Tekken world, bringing a whole new level of immersion and excitement. Get ready to bring your fighting skills to life in this one-of-a-kind experience.
            </p>
          </div>
        </div>
        <div className="eventpage-description">
